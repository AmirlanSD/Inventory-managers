...
public class ProductManagerPage implements Initializable{
    ...
    public void manageCatalogueButton_OnAction (Event event) throws IOException {
        Stage catalogueStage = new Stage();
        catalogueStage.setScene(new Scene(FXMLLoader.load(getClass().getResource("/view/CatalogueTable.fxml"))));
        catalogueStage.setWidth(960);
        catalogueStage.setHeight(540);
        catalogueStage.setResizable(false);
        catalogueStage.setTitle("angyeOng | Product Catalogue System | Product Manager Page | Catalogue Management");
        catalogueStage.show();
    }
    ...
    public void logOutButton_OnAction(Event event) throws IOException{
        ...
        catalogueStage.setHeight(540);
        catalogueStage.setResizable(false);
        catalogueStage.setTitle("angyeOng | Product Manager Page |Product Catalogue System");
        catalogueStage.show();
